...
This WFST is more liberally pruned in order to fit on GitHub. It achieves 54.3% exact matches on .1% held out data from the CMU Pronunciation Dictionary. A less pruned and larger WFST achieves 66.9% accuracy in the same experiment. For access to the larger machine, contact Aliya Deri at aderi@isi.edu or Kevin Knight at knight@isi.edu.